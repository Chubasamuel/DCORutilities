...
To generate unique Integers, ((maximumInteger-minimumInteger)+1) must be the same as the value provided for howMany OR it could be lesser or equal, but must be greater than 0;
